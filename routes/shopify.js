...
router.get('/install', function (req, res, next) {
    ...
    console.log("store tokemnmmmmmmmmmmmmmmmmmmmmmm")
    console.log(process.env.appStoreTokenTest.length > 0)
    ...
    if (securityPass && regex) {
        ...
        request.post(accessTokenRequestUrl, { json: accessTokenPayload })
            .then((accessTokenResponse) => {
                ...
                process.env["appStoreTokenTest"] = accessTokenResponse.access_token;
...
router.get('/app/products', function (req, res, next) {
    ...
    console.log(process.env.appStoreTokenTest)
    ...
    let url = 'https://' + req.query.shop + '/admin/metafields.json';
    console.log("1111111111111")
    console.log(process.env.appStoreTokenTest)
